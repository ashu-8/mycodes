...
//  const pass= bcrypt.hash("host",12);
// bcrypt.hash("host",12).then(hashedpassword=>{
//   const user=new usermodel({name:"host",email:"host@gmail.com",password: hashedpassword,level:"admin"});
//   user.save();
// })
const app=express();
...
mongoose.connect('mongodb://localhost:27017/PlacementPortal', {useNewUrlParser: true,useUnifiedTopology: true});

const store=new MongoDBStore({
  uri:"mongodb://localhost:27017/PlacementPortal",
  collection:'sessions'
})
app.use(session({
  secret:'my secret',
