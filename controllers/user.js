...
exports.getdashboard=(req,res)=>{
    usermodel.findOne({_id:req.session.user._id}).then(sessionuser=>{
        ...
        res.render('userdashboard',{pagetitle:'User Dashboard',session:sessionuser});
    })
...
exports.getopportunities=(req,res)=>{
    ...
    companymodel.find().sort({time:-1}).then(companies=>{
        ...
        res.render('useropportunities',{pagetitle:'Opportunities',companies:companies,session:sessionuser});
    })
})
...
exports.getopportunitiessingle=(req,res)=>{
    ...
    companymodel.findById(id).then(company=>{
        res.render('companysingle',{pagetitle:'Company Information',company:company,session:sessionuser})
